...
set nocompatible                "deshabilitar la compatibilidad con vi
...
set shiftwidth=2                "identar con 2 espacios
set showmatch                   "mostrar parentesis correspondiente
set signcolumn=yes              "habilitar columna izquierda
"set smartindent                 "habilitar autoidentacion
